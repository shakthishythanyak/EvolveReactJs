...
import { Status } from '../../Interfaces/task/ITaskInfo';
import './task.css'
import { initialTasks} from '../../App';
import { TaskCard } from '../taskCard/taskCard';

export function Addtask(status:Status)
{
    ...
    const addTask = () =>
    {
      const taskToBeAdded = JSON.stringify({taskName,dueDate:selectedDate,status,assignee:selectedValue});
      const task = JSON.parse(taskToBeAdded);
